    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'flex', gap: 8, borderTop: '0.5px solid #F1F7E8', paddingTop: 12 }}>
                <div className="skeleton" style={{ height: 34, width: 72, borderRadius: 14 }} />
    ...
    return (
        <div className="animate-fade-up" style={{
            ...
            <p style={{ fontSize: 16, fontWeight: 700, color: '#173404', margin: '0 0 8px' }}>
                {isFiltered ? `Sin publicaciones en "${filter}"` : 'Aún no hay publicaciones'}
            </p>
                            ...
                            <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                ...
                                <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                        ...
                                        <label style={{
                                            padding: '8px 16px', borderRadius: 10, border: '0.5px dashed #97C459',
                                            background: '#FAFCF7', color: '#639922', fontSize: 12, fontWeight: 600,
