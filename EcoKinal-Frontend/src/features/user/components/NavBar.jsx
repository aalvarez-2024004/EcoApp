...
export default function NavBar() {
  ...
  const handleNavigation = (href) => {
    navigate(href)
    setIsOpen(false) // Cierra el menú tras hacer click en móvil
  }
    ...
    <>
      <style>{`
        ...
        .eco-menu-toggle:hover {
          background: var(--nav-bone);
        }

        /* Contenedor de enlaces de escritorio */
        .eco-nav-container {
          display: flex;
          align-items: center;
          justify-content: space-between;
        ...
        .eco-nav-item.active {
          ...
          color: white;
          box-shadow: 0 4px 10px rgba(27, 60, 26, 0.15);
        }
        ...
        /* ── Responsividad con Menú Desplegable Avanzado ── */
        @media (max-width: 1024px) {
          .eco-navbar {
            padding: 1rem 1.5rem;
            flex-wrap: wrap; /* Permite bajar el menú */
          }
          ...
          .eco-nav-container {
            ...
            width: 100%;
            margin-left: 0;
            max-height: ${isOpen ? '400px' : '0px'}; /* Colapso animado */
            overflow: hidden;
      ...
      <nav className="eco-navbar">
        ...
        {/* Bloque de navegación colapsable */}
