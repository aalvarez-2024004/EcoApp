export const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ek-signup { margin-top: 8px; font-size: 14px; color: var(--eco-muted); text-align: center; }
