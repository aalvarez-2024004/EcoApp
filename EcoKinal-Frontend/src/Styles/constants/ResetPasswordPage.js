export const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ek-match-icon { position: absolute; right: 12px; display: flex; align-items: center; }

  .ek-strength { display: flex; align-items: center; gap: 8px; margin-top: 6px; }
  .ek-strength-bar { display: flex; gap: 4px; flex: 1; }
  .ek-strength-seg { height: 4px; flex: 1; border-radius: 2px; transition: background 0.3s; }
  .ek-strength span { font-size: 12px; font-weight: 600; min-width: 48px; }
