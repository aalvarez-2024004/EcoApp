export const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ek-input-wrap input:focus {
    ...
    box-shadow: 0 0 0 4px rgba(89,177,48,.12), 0 10px 24px rgba(89,177,48,.10);
  ...
  .ek-eye:hover { color: var(--green-700); }
  ...
  .ek-signup a { color: var(--green-700); font-weight: 600; text-decoration: none; }
  ...
  .ek-right-icon {
    ...
    object-fit: contain;
    display: block;
    margin: 0 auto clamp(12px, 2vw, 24px) auto;
    opacity: .95;
    position: relative;
    z-index: 1;
  ...
  .ek-step-dot--active { background: var(--green-600); }
  .ek-step-line {
  ...
  .ek-step-line--done { background: var(--green-600); }
  .ek-step-label {
    font-size: 11px;
    font-weight: 600;
    color: var(--muted);
  ...
  .ek-toast--success { background: var(--green-700); color: white; }
  ...
  /* ══════════════════════════════════════════
     BREAKPOINTS — misma lógica que LoginPage
  ══════════════════════════════════════════ */
  ...
  @media (max-width: 1024px) {
    ...
    .ek-right { padding: 0 28px 36px; }
  }

  /* ── TABLET LANDSCAPE (≤ 768px) — ambos paneles visibles ── */
  @media (max-width: 768px) {
    ...
    .ek-brand        { margin-bottom: 16px; padding-bottom: 16px; }
    .ek-heading      { margin-bottom: 14px; }
    .ek-heading h1   { font-size: 28px; }
    .ek-heading p    { font-size: 12px; }
    .ek-form         { gap: 10px; }
    .ek-steps        { margin-bottom: 12px; }
    .ek-step-label   { font-size: 10px; }
    .ek-signup       { margin-top: 14px; font-size: 12px; }
    ...
    .ek-right-text { padding: 0 12px 20px; }
    .ek-right-text h2 { font-size: 20px; }
    .ek-right-text p  { font-size: 11px; line-height: 1.5; }
  }

  /* ── MÓVIL (≤ 540px) — ambos paneles, derecho compacto ── */
  @media (max-width: 540px) {
    ...
    .ek-heading p    { font-size: 11px; }
    .ek-brand        { margin-bottom: 10px; padding-bottom: 10px; }
    .ek-heading      { margin-bottom: 10px; }
    .ek-form         { gap: 8px; }
    .ek-step-label   { display: none; }
    .ek-signup       { margin-top: 10px; font-size: 11px; }

    .ek-row-fields   { grid-template-columns: 1fr; }

    .ek-field label  { font-size: 10px; }
    ...
    .ek-back-slider        { width: 30px; height: 30px; border-radius: 8px; }
    .ek-back-btn:hover .ek-back-slider { width: 104px; }

    .ek-right-text h2 { font-size: 14px; margin-bottom: 4px; }
    .ek-right-text p  { font-size: 10px; line-height: 1.4; }
  }

  /* ── MÓVIL PEQUEÑO (≤ 380px) ── */
  @media (max-width: 380px) {
    .ek-left  { padding: 18px 12px; }
    .ek-right { padding: 0 8px 14px; }

    .ek-heading h1 { font-size: 18px; }

    .ek-input-wrap input { height: 36px; font-size: 11px; padding: 0 30px; }
    .ek-btn              { min-height: 36px; font-size: 11px; }
    ...
    .ek-back-slider        { width: 24px; height: 24px; border-radius: 6px; }
  ...
  @media (min-width: 1280px) {
    ...
    .ek-right { padding: 0 56px 64px; }
    .ek-right-text h2 { font-size: 48px; }
  }

  /* ── DESKTOP XL (≥ 1600px) ── */
  @media (min-width: 1600px) {
    .ek-left { max-width: 640px; padding: 80px 96px; }
  }
`