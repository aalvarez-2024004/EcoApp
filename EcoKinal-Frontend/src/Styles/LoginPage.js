export const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ek-right-text p { font-size: 14px; color: rgba(255,255,255,0.6); line-height: 1.6; }
